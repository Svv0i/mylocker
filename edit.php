    ...
    <div class="container">
        <div class="form-box box">
            ...
            if (isset($_POST['update'])) {
                ...
                $id = $_SESSION['id'];
                if (filter_var($username, FILTER_SANITIZE_STRING) && filter_var($$email, FILTER_SANITIZE_STRING))  {
                ...
                <p>Profile Updated!</p>
                    ...
                    echo "<div class='message'>
                    <p>invalid email or user name </p>
                    </div><br>";
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-box">
                        ...
                        <div class="input-container">
                            ...
                            <input class="input-field password" type="password" placeholder="New Password" name="password"
                                value="" >
